...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(430, 168);
    ...
    public Mat processFrame(Mat input) {
        ...
        Imgproc.rectangle(areaMat, new Rect(sleeve_pointA, sleeve_pointB), new Scalar(255, 0, 0), 2); // draw rectangles around the boxes
